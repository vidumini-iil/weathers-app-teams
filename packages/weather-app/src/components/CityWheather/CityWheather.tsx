...
export function CityWheather(props: CityItemProps) {
    ...
    const timeConverter = (UNIX_timestamp: number) => {
        ...
        let meridiemTime =
            (parseInt(times[0]) >= 12 && (parseInt(times[0]) - 12 || 12) + ":" + times[1] + "pm") ||
    ...
    const onChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        dispatch(setNotification({ notification: e.target.checked, activeCity: props.city.name }));
    };
    ...
    return (
        <div className="city-child">
            <div className="city-title">
                ...
                <img src={backIcon} className="city-back-icon" onClick={() => history.goBack()} alt="city-back-icon" />
            </div>
            <div className="city-top-bar">
                <div className="city-town city-two-common">
                    <div className="city-town-w">
                        ...
                        />
                        <span className="city-wheather-text">{props.city.weather[0].description}</span>
                    </div>
                </div>
            ...
            <div className="city-bottom-bar">
                ...
                <div className="city-degree city-three-common">
                    <div className="city-three-common-wrapper">
                        <img src={degreeIcon} className="city-degree-icon" alt="city-degree-icon" />
                        <p>
